...
#define ItemH                   44
#define TextViewH               36
#define TextViewVerticalOffset  (49-TextViewH)/2.0
#define ItemVerticalOffset      (49-ItemH)/2.0
...
- (void)setbarSubViewsFrame
{
    if (self.allowSwitchBar) {
        self.switchBarBtn.frame = CGRectMake(0, ItemVerticalOffset, ItemW, ItemH);
    }else {
        self.switchBarBtn.frame = CGRectZero;
    }
    
    if (self.allowVoice){
        self.voiceBtn.frame = CGRectMake(CGRectGetMaxX(self.switchBarBtn.frame), ItemVerticalOffset, ItemW, ItemH);
    }else {
        self.voiceBtn.frame = CGRectZero;
    }
    
    if (self.allowMoreFunc) {
        self.moreBtn.frame = CGRectMake(self.frame.size.width - ItemW, ItemVerticalOffset, ItemW, ItemH);
    }else {
        self.moreBtn.frame = CGRectZero;
    }
    
    if (self.allowFace){
        self.faceBtn.frame = CGRectMake(self.frame.size.width - ItemW - CGRectGetWidth(self.moreBtn.frame), ItemVerticalOffset, ItemW, ItemH);
    }else {
