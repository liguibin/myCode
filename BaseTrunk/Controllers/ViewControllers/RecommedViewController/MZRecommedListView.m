...
@implementation MZRecommedListView
...
- (void)setObject:(id)item {
    ...
    if (item && [self.videoListInfoObject parseData:item]) {
        [self.coverView sd_setImageWithURL:[MZConfig getImageUrl:self.videoListInfoObject.coverUrl] placeholderImage:[UIImage imageNamed:iphoneX?@"xwaiting_page":@"waiting_page"] options:SDWebImageLowPriority|SDWebImageRetryFailed completed:nil];
