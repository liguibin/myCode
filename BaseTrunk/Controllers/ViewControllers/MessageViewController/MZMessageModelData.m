...
@implementation MZMessageModelData
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        if (0/*[NSUserDefaults emptyMessagesSetting]*/) {
...
- (void)loadFakeMessages
{
     ...
     */
    if (1/*[NSUserDefaults extraMessagesSetting]*/) {
     ...
     */
    if (1/*[NSUserDefaults longMessageSetting]*/) {
