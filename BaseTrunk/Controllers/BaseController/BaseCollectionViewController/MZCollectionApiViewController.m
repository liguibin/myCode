//
//  MZCollectionApiViewController.m
//  BaseTrunk
//
...
#import "MZCollectionCellDelegate.h"
#import "MZFileClient.h"

@interface MZCollectionApiViewController () <UICollectionViewDataSource, UICollectionViewDelegate>

@end

@implementation MZCollectionApiViewController
...
- (MZErrorView *)errorView
{
    if(!_errorView)
    {
        _errorView = [[MZErrorView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, self.view.width)];
...
- (void)didFailWithError:(NSError *)error
{
    ...
    if ([error.domain isEqualToString:ERROR_DOMAIN]) {
        ...
        if([[MZFileClient sharedInstance] getNetworkingType] == 0) {
