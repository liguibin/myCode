...
{
    static MZFileClient *instance = nil;
...
- (void)request_send:(MZParamsBaseObject*)model cachePolicy:(NSURLRequestCachePolicy)cholicy  delegate:(id)theDelegate selector:(SEL)theSelector selectorError:(SEL)theSelectorError
{
    MZRequestSender *requestSender = [MZRequestSender requestSenderWithParams:model
...
- (void)request_send:(MZParamsBaseObject *)model
