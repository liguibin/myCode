...
+ (MZAppDelegate*)shareInstance
{
    return (MZAppDelegate*)[[UIApplication sharedApplication] delegate];
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //读取本地用户信息
    MZMainAppViewController *mainViewController = [MZMainAppViewController new];
